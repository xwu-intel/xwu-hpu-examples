...
python3 $SCRIPTDIR/overrun_in_json.py -i $SCRIPTDIR/deepspeed_config_bert_tiny_zero3.json -o ${HL_DS_CONFIG}

export HL_NUM_NODES=${QA_NUM_NODES:-1}
export HL_RUN_STEPS=${QA_RUN_STEPS:-40000}
export HL_LOG_FREQ=${QA_LOG_FREQ:-100}
export HL_RESULTS_DIR=${QA_RESULTS_DIR:-"./results/bert_tiny_zero3/"}
